        ...
        <div className="mt-2.5 flex items-start justify-between gap-2 sm:mt-3">
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              <h3 className="truncate text-sm font-bold text-foreground transition-colors group-hover:text-accent">
                {seller.name}
              </h3>
              {seller.verified && (
                <BadgeCheck className="h-3.5 w-3.5 shrink-0 text-info sm:h-4 sm:w-4" />
              )}
            </div>
