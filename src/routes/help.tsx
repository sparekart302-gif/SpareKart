...
const faqs = [
  {
    ...
    a: "Place your order, choose COD, and pay our courier in cash when your parcel arrives. Available across all major cities in Pakistan.",
  },
  {
    q: "What if a part doesn't fit my car?",
    a: "Every part on SpareKart is backed by our fitment guarantee. If it doesn't fit, return it within 7 days for a full refund or free replacement.",
  },
  {
    q: "How long does delivery take?",
    a: "Standard delivery is 3–5 business days nationwide. Express delivery (1–2 days) is available from most sellers in metropolitan areas.",
  },
  {
    q: "How do I upload payment proof?",
    a: "After choosing Bank Transfer, Easypaisa or JazzCash at checkout, you'll see a secure upload area. Drop a screenshot or photo of your receipt and we'll verify within 24 hours.",
  },
  {
    q: "Are all sellers verified?",
    a: "Yes. Every seller on SpareKart is vetted by our trust team and continuously monitored through buyer ratings and reviews.",
  },
  {
    q: "How do I become a seller?",
    a: "Visit our Become a Seller page to apply. Approval typically takes 2–3 business days.",
  },
];
      ...
      <section className="container mx-auto px-4 pb-10 sm:pb-12 md:pb-16">
        ...
        <div className="mx-auto mt-8 grid max-w-3xl grid-cols-2 gap-3 sm:mt-10 sm:gap-4 md:grid-cols-4">
          {[
            ...
            <div
              key={c.title}
              className="cursor-pointer rounded-[20px] bg-surface p-4 text-center shadow-[var(--shadow-soft)] transition-all hover:-translate-y-0.5 hover:shadow-[var(--shadow-elevated)] sm:rounded-[24px] sm:p-5"
            >
              <div className="mx-auto grid h-10 w-10 place-items-center rounded-xl bg-accent-soft text-accent sm:h-12 sm:w-12">
        ...
        <div className="mx-auto mt-10 max-w-3xl sm:mt-12">
          <h2 className="mb-4 flex items-center gap-2 text-[1.6rem] font-black sm:mb-5 sm:text-2xl">
