    ...
    <PageLayout>
      ...
      <section className="container mx-auto px-4 pb-10 sm:pb-12 md:pb-16">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-1 text-[2rem] font-black tracking-tight sm:text-3xl md:text-5xl">
            All verified sellers
          </h1>
          <p className="mt-3 text-muted-foreground text-balance">
            Every store on SpareKart is verified, rated, and held to our marketplace standards.
            Browse the people behind the parts.
          </p>
        </div>
